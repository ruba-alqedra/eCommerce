...
<div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(layout/images/bg/6.jpg) no-repeat scroll center center / cover ;">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="buttons-cart--inner">
                                <div class="buttons-cart">
                                    <a href="<?php echo SITE_PATH ?>website">Continue Shopping</a>
                                </div>
                                <div class="buttons-cart checkout--btn">
                                    <a href="<?php echo SITE_PATH ?>website/checkout.php">checkout</a>
                                </div>
                            </div>
                        </div>
                    </div>
